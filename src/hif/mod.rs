...
pub use self::libhif::{hif_context_new, hif_state_new, hif_context_setup_sack, hif_context_setup,
                       GError, hif_context_set_solv_dir, hif_context_set_repo_dir,
                       hif_context_set_lock_dir, hif_context_set_cache_dir, HifContext,
                       hy_query_filter_latest_per_arch, hy_query_create, hy_query_filter,
                       hy_query_run, HyQuery, GPtrArray, HifPackage, HifSack,
                       hif_context_get_sack, hif_context_get_native_arches, hy_query_filter_in,
                       hif_package_get_nevra, g_ptr_array_free, hy_query_free,
